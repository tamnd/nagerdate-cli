...
Most of these come down to network reality or how nagerdate serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

nagerdate rate-limits like any public site. nagerdate already paces
...
Where a surface is gated, nagerdate reads a cookie or token you supply
...
`nagerdate`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what nagerdate actually did
