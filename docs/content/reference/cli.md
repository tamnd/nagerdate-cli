...
```
nagerdate <command> [arguments] [flags]
```

Run `nagerdate <command> --help` for the full flag list on any command. This
...
per operation you declare in `nagerdate/domain.go`.
